...
Common::Jit_data_array<int, 32> frsqrte_expected_base = {
...
Common::Jit_data_array<int, 32> frsqrte_expected_dec = {
...
Common::Jit_data_array<int, 32> fres_expected_base = {
...
Common::Jit_data_array<int, 32> fres_expected_dec = {
