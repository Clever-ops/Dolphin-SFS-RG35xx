...
static struct retro_input_descriptor descGC[] = {
    ...
    {0, RETRO_DEVICE_ANALOG, RETRO_DEVICE_INDEX_ANALOG_BUTTON, RETRO_DEVICE_ID_ANALOG_X, 
     "L-Analog"}
    {0, RETRO_DEVICE_ANALOG, RETRO_DEVICE_INDEX_ANALOG_BUTTON, RETRO_DEVICE_ID_ANALOG_Y, 
     "R-Analog"}
