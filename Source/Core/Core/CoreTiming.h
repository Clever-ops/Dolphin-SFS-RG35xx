...
extern Common::Jit_data<s64> g_global_timer;
extern Common::Jit_data<u64> g_fake_TB_start_value;
extern Common::Jit_data<u64> g_fake_TB_start_ticks;
extern Common::Jit_data<int> g_slice_length;
extern Common::Jit_data<float> g_last_OC_factor_inverted;
